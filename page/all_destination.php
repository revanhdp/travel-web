...
$sql = "SELECT * FROM destination_cards";
...
<head>
    ...
    <title>All Destination Page</title>
...
<body class="background">
    ...
    <div class="d-flex justify-content-between align-items-center" style="background-color: #000000; padding: 0 300px 0 300px">
        ...
        <div>
            <img class="mb-2" src="assets/asia.png" style="height: 150px; width: 150px" alt="">
        </div>
    </div>
        ...
        <?php foreach ($cards as $card): ?>
            <div class="card" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-danger"><?php echo strtoupper($card['kategori']); ?></p>
